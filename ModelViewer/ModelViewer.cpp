...
void ModelViewer::LoadAssets()
{
    ...
    cbvSrvHeapDesc.NumDescriptors = 1 + 1 + m_pModel->primitiveSize + (m_pModel->materialSize * 6) + 1;
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE srvHandle(m_cbvSrvHeap->GetCPUDescriptorHandleForHeapStart(), m_pModel->cbvSrvOffsetEnd, m_cbvSrvDescriptorSize);
